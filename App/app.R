...
ui <- dashboardPage(skin="red",
                    dashboardHeader(title="XCJ", titleWidth=12),
                    dashboardSidebar(
                      sidebarMenu(
                        menuItem("About", tabName = "about", icon=icon('archive')),
                        menuItem("Clustering", tabName ="Tab1", icon = icon("pie-chart")),
                        menuItem("Hypothesis Testing", tabName ="Tab2", icon = icon("eye")),
                        menuItem("Khronus", tabName ="Tab3", icon = icon("hourglass"))
                      )
                    ),
                    dashboardBody(
                      tabItems(
                    ...
                    ")),
                        ...
                        tabItem(
                          ...
                          fluidPage(
                            # Application title
                            titlePanel("Clustering Categorical Functional Data"),
                            sidebarLayout(
                              sidebarPanel(
                                box(width = 18,
                                ...
                                box(width = 18,
                                    radioButtons("est_choice","Estimation choice:",
                                             c("Probit"="probit",
                                               "Multinormial"="multinormial",
                                               "Binomil"="binomial")),
                                    helpText("Estimation choice")
                                ),
                                
                                box(width = 18,
                                  sliderInput("num_indvs",
                                              "Number of individuals",
                                              min = 100,
                                              max = 2000,
                                              step=200,
                                              value = 100),
                                  helpText("Number of individuals")
                                ),
                                box(width = 18,
                                sliderInput("timeseries_length",
                                            "n=Number of points in each sample path",
                                            min = 90,
                                            max = 2000,
                                            step=90,
                                            value = 90),
                                helpText("Length of timeseries")
                                ),
                                box(width = 18,
                                  radioButtons("scenario","Scenario choice:",
                                             c("A"="A","B"="B","C"="C")),
                                  helpText("Scenario choice")
                                ),
                                box(width = 18,
                                sliderInput("num_replicas",
                                            "Number of replicas",
                                            min = 90,
                                            max = 2000,
                                            step=90,
                              ...
                              mainPanel(
                                ...
                                helpText(h4("Hitler wrote this!!!")),
                                helpText(h4("Hitler doesn't want me to eat")),
                                helpText(h4('xxx')),
                                splitLayout(
                        ...
                        tabItem(
                          ...
                          fluidPage(
                            # Application title
                            titlePanel("Categorical Functional Data Hypothesis Testing"),
                            sidebarLayout(
                              sidebarPanel(
                                box(width = 18,
                                    helpText(h3("Visualize \\(X_n\\overset{a.s.} {\\to} 0\\) implies \\(X_n\\overset{p} {\\to} 0\\)"))
